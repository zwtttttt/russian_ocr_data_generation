...
def parse():
    ...
    parser.add_argument('--random_color', type=int, default=0, help='[0, 1] 0: default color #000000, 1: random color.')
    parser.add_argument('--random_font', type=int, default=1, help='[0, 1] 0: default font, 1: random font in the font path files.')
    parser.add_argument('--multi_size', type=int, default=0, help='[0, 1] 0: stable font size, 1: multi size in [fontsize * 0.8, fontsize * 1.2].')
    
    # The argument about some path.
    parser.add_argument('--save_path', type=str, default='./data', help='the path u wanna save the img data.')
    parser.add_argument('--font_path', type=str, default='./fonts', help='the path for the font file.')
